...
class GameEvents:
    ...
    async def _Register(self, events: List[str]) -> List[bool]:
        Obj = {"method": "subscribe", "module": "gameevents", "events": events}
    ...
    async def _Unregister(self, events: List[str]) -> List[bool]:
        ...
        Obj = {"method": "unsubscribe", "module": "gameevents", "events": events}
    ...
    async def Replay(self, events: List[str]) -> List[bool]:
        ...
        Obj = {"method": "replay", "module": "gameevents", "events": events}
